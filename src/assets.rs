...
pub struct Assets {
    ...
    pub button_asset: ButtonAsset,
    pub alert_asset: AlertAsset,
    pub bars_asset: BarsAsset,
}
...
impl Assets {
    ...
    pub fn new(ctx: &mut Context) -> tetra::Result<Self> {
        ...
        Ok(Assets {
            tileset: Tileset {
                texture: Texture::from_file_data(ctx, include_bytes!("../res/img/tileset.png"))?,
            ...
            images: Images {
                ...
                halloween: Texture::from_file_data(
                    ctx,
                    include_bytes!("../res/img/halloween.jpg"),
                )?,
            ...
            button_asset: ButtonAsset {
                texture: Texture::from_file_data(ctx, include_bytes!("../res/img/button.png"))?,
            ...
            alert_asset: AlertAsset {
                texture: Texture::from_file_data(ctx, include_bytes!("../res/img/alert.png"))?,
                nineslice: NineSlice::new(Rectangle::new(0.0, 0.0, 48.0, 32.0), 6.0, 6.0, 6.0, 5.0),
            },
            bars_asset: BarsAsset {
