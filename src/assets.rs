    ...
    pub fn new(ctx: &mut Context) -> tetra::Result<Self> {
        ...
        Ok(Assets {
            ...
            regions: TilesetRegions {
                ...
                grass3: Rectangle::new(20.0, 40.0, 10.0, 10.0),
                grass4: Rectangle::new(30.0, 40.0, 10.0, 10.0),
                grass5: Rectangle::new(40.0, 40.0, 10.0, 10.0),
                grass6: Rectangle::new(50.0, 40.0, 10.0, 10.0),
                grass7: Rectangle::new(60.0, 40.0, 10.0, 10.0),
                grass8: Rectangle::new(0.0, 60.0, 10.0, 10.0),
                grass9: Rectangle::new(10.0, 60.0, 10.0, 10.0),
                grass10: Rectangle::new(20.0, 60.0, 10.0, 10.0),
                grass11: Rectangle::new(30.0, 60.0, 10.0, 10.0),
                grass12: Rectangle::new(40.0, 60.0, 10.0, 10.0),
                grass13: Rectangle::new(50.0, 60.0, 10.0, 10.0),
                grass14: Rectangle::new(60.0, 60.0, 10.0, 10.0),
                dead_grass1: Rectangle::new(0.0, 50.0, 10.0, 10.0),
                dead_grass2: Rectangle::new(10.0, 50.0, 10.0, 10.0),
                dead_grass3: Rectangle::new(20.0, 50.0, 10.0, 10.0),
                dead_grass4: Rectangle::new(30.0, 50.0, 10.0, 10.0),
                dead_grass5: Rectangle::new(40.0, 50.0, 10.0, 10.0),
                dead_grass6: Rectangle::new(50.0, 50.0, 10.0, 10.0),
                dead_grass7: Rectangle::new(60.0, 50.0, 10.0, 10.0),
                dead_grass8: Rectangle::new(0.0, 70.0, 10.0, 10.0),
                dead_grass9: Rectangle::new(10.0, 70.0, 10.0, 10.0),
                dead_grass10: Rectangle::new(20.0, 70.0, 10.0, 10.0),
                dead_grass11: Rectangle::new(30.0, 70.0, 10.0, 10.0),
                dead_grass12: Rectangle::new(40.0, 70.0, 10.0, 10.0),
